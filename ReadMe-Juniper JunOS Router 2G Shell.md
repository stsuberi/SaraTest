...
|Command|Description|
|:-----|:-----|
|Run Custom Command|Executes any custom command entered inthe input on the device. <br>Set the command input as follows:<br>▪ **Custom Command**: The command to run. Note that commands requiring a response are not supported.|
