...
|Restore|Restores a configuration from the saved file.<br>Command Inputs:</br><li>**Path**: including the configuration file name. The path should include the protocol type, for example: tftp://asdf.</br><li>**Configuration Type**: Specify whether the file should update the Startup or Running config. Startup configuration is not supported on all switches.</br><li>**Restore Method**: Determines whether the restore should append or override the current configuration.|
