...
### **Pluribus Netvisor Vle L1 Shell**
**Pluribus Netvisor Vle L1 Shell** shell provides you with the capability to communicate with network topology managed by the pluribus netvisor vle.
...
For more information on the **pluribus netvisor vle**, see the official **[Device Manufacturer]** product documentation.

### Standard version
The **pluribus netvisor vle** shell is based on the [**Layer 1 Switch Shell Standard**](https://github.com/QualiSystems/shell-L1-template).
...
The **pluribus netvisor vle** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 

The shell comprises:

|File name|Description|
|:---|:---|
|cloudshell-L1-pluribus_netvisor_vle-1.0.0.zip|pluribus netvisor vle shell package|
|install_driver.bat|pluribus netvisor vle shell installation script|
...
**To import and configure the shell in CloudShell:**
  ...
  *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers*
  ...
  5. Create an L1 resource.
      ...
      4. Ensure that the correct **Model** Pluribus Netvisor Vle Chassis and **Driver** PLURIBUS NETVISOR VLE are selected.
      5. Click **OK**.
