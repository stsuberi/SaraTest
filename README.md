...
For more information, see Traffic Generators Overview.
...
The Ixia Chassis shell is compatible with two different controllers, see [About Ixia Chassis 2G Shells](#about-ixia-chassis-2G-shells).
